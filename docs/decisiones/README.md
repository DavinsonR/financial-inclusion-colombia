...
| [005](ADR-005-quarto-pages-atlas-ojs.md) | Quarto + GitHub Pages + atlas en Observable JS | aceptada |
...
| [014](ADR-014-snowflake.md) | Snowflake en producción, DuckDB en local y CI | propuesta |
