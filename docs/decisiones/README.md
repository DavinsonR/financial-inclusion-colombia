...
| [006](ADR-006-notebook-legado-congelado.md) | Artefactos del trabajo de grado congelados como insumo, no como resultado | aceptada, con adenda |
| [007](ADR-007-crosswalk-por-departamento.md) | Crosswalk nombre a DIVIPOLA por departamento, con overrides | aceptada, con adenda |
...
| [013](ADR-013-bogota-separada-y-anm.md) | Bogotá separada en el panel departamental y áreas no municipalizadas conservadas | aceptada |
