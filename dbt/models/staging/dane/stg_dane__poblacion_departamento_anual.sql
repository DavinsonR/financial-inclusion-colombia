...
select dpto_ccdgo, departamento, cast(anio as integer) as anio, cast(anio as {{ dbt.type_string() }}) as periodo_id, area, cast(poblacion as bigint) as poblacion, fuente
