...
CLAVES del archivo estuvieran, no sus valores: el código y el número podían separarse en silencio (B-072 en
...
def test_el_moran_publicado_se_mide_sobre_los_residuos(publicado):
    """B-068: la tabla publica los tres objetos y el de los residuos es el que sostiene la afirmación."""
